...
| **Output baseline** | Fusion **v9** (Rev 6) · RK-A-DWG Rev 3 · RK-A-MFG Rev 3 · RK-A-QC Rev 4 · RK-A-SYS Rev 2 addendum B · RK-A-PARAM Rev 2 · decision records EDR-014…020, ICR-005…007 |
| **Owner decisions** | Recorded 2026-09-10 (Section 2) |
| **Status** | Part 1 (design, decisions, verification) complete. Part 2 (CAD v9, document reissue) executes when Fusion and the repository are linked. |
